...
-- FIN_PLANO_CONTA
ALTER TABLE FIN_PLANO_CONTA ADD COLUMN IF NOT EXISTS EMPRESA_ID INTEGER REFERENCES EMP_EMPRESA(ID_EMPRESA);
...
-- FIN_CENTRO_CUSTO
ALTER TABLE FIN_CENTRO_CUSTO ADD COLUMN IF NOT EXISTS EMPRESA_ID INTEGER REFERENCES EMP_EMPRESA(ID_EMPRESA);
...
-- FIN_ESTRUTURA_DRE
ALTER TABLE FIN_ESTRUTURA_DRE ADD COLUMN IF NOT EXISTS EMPRESA_ID INTEGER REFERENCES EMP_EMPRESA(ID_EMPRESA);
...
ALTER TABLE FIN_ESTRUTURA_DRE_CONTA ADD COLUMN IF NOT EXISTS EMPRESA_ID INTEGER REFERENCES EMP_EMPRESA(ID_EMPRESA);
...
-- FIN_LANCAMENTO
ALTER TABLE FIN_LANCAMENTO ADD COLUMN IF NOT EXISTS EMPRESA_ID INTEGER REFERENCES EMP_EMPRESA(ID_EMPRESA);
