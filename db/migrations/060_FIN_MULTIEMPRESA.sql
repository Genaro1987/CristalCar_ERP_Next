...
-- Normaliza nomenclatura do campo de empresa
ALTER TABLE FIN_PLANO_CONTA RENAME COLUMN EMPRESA_ID TO ID_EMPRESA;
...
-- Normaliza nomenclatura do campo de empresa
ALTER TABLE FIN_CENTRO_CUSTO RENAME COLUMN EMPRESA_ID TO ID_EMPRESA;
...
-- Normaliza nomenclatura do campo de empresa
ALTER TABLE FIN_ESTRUTURA_DRE RENAME COLUMN EMPRESA_ID TO ID_EMPRESA;
...
-- Normaliza nomenclatura do campo de empresa
ALTER TABLE FIN_ESTRUTURA_DRE_CONTA RENAME COLUMN EMPRESA_ID TO ID_EMPRESA;
...
-- Normaliza nomenclatura do campo de empresa
ALTER TABLE FIN_LANCAMENTO RENAME COLUMN EMPRESA_ID TO ID_EMPRESA;
