...
-- ============================================
-- 2. ADD ORDEM_MENU COLUMN FOR MENU ORDERING
-- ============================================
...
UPDATE CORE_TELA SET ORDEM_MENU = 100 WHERE CODIGO_TELA = 'CORE010_SELECAO_EMPRESA' OR CODIGO_TELA = 'CAD001_EMP_SELECAO';
...
-- ============================================
-- 3. CREATE HELP FOR OBJETIVOS SEMANAIS
-- ============================================
...
-- ============================================
-- 4. CREATE HELP FOR DRE (FIN_DRE) if missing
-- ============================================
INSERT OR REPLACE INTO CORE_AJUDA_TELA (
  ID_AJUDA, ID_TELA,
  OBJETIVO_TELA, QUANDO_UTILIZAR, DESCRICAO_PROCESSO,
