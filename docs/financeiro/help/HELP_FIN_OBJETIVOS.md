# Objetivos Financeiros (FIN_OBJETIVOS)

## Importância da tela
Concentra metas estratégicas por empresa (receita, margem, investimentos), conectando-as aos lançamentos e ao DRE.
...
- Sincronizar metas com o dashboard e com objetivos semanais.
- Disponibilizar histórico de revisões e aprovação.
- Exibir alertas quando lançamentos divergirem da rota planejada.
