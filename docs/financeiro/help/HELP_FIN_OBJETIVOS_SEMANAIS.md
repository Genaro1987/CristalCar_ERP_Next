# Objetivos Semanais (FIN_OBJETIVOS_SEMANAIS)

## Importância da tela
Quebra metas financeiras em entregas semanais, facilitando ajustes rápidos por empresa e área.
...
- Integrar com notificações para lembrar tarefas críticas.
- Permitir replanejamento rápido quando a meta principal mudar.
- Expor API para alimentar dashboards e relatórios semanais.
